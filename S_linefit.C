// Line fitting macro written for ROOT
{
  ...
  float x[ndata] = {     0.17364,  0.34202,  0.5,  0.64278,  0.76604,  0.86602, 0.93969, 0.98480, 1.0};
  float y[ndata] = {33,  42,  64, 97, 112, 127, 130, 165, 138};
  float sy[ndata]= {5.74,  6.48,  8,  9.85,  10.58,  11.27, 11.40, 12.85, 11.75};
